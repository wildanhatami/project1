  ...
  return (
    <div className="flex flex-col items-center w-full pt-16 pb-24">
      ...
      <div className="text-center mb-16 px-6 flex flex-col items-center gap-4 max-w-2xl animate-in fade-in slide-in-from-bottom-6 duration-700">
        <h1 className="font-serif text-4xl md:text-5xl font-bold text-brand-brown">Katalog Kue Favorit</h1>
        <p className="text-brand-gray text-lg">
          Temukan pilihan kue artisanal terbaik kami, dibuat dengan bahan premium untuk setiap momen spesial Anda.
        </p>
      </div>
